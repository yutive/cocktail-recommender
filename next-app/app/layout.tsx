        ...
        <body className="min-h-screen bg-gray-700">
            <div className="flex items-center justify-center relative">
                <div
                    ...
                    <Link href="/history">
                        <svg className="h-12 w-12 p-1 pl-2 pr-2 hover:bg-slate-600 rounded-xl transition ease-in-out delay-75" width="800px" height="800px" viewBox="0 0 24 24" fill="none"
